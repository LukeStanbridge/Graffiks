...
bool Application::startup()
{
    ...
    for (int i = -5; i < 6; i++)
    {
        m_scene->AddInstance(new Instance(glm::vec3(i * 2, 0, 0), glm::vec3(0), glm::vec3(1), &m_spearMesh, &m_normalMapShader));   
    }
...
void Application::draw()
{
    ...
    //GUI Creation
    ImGui::Begin("Red Light Settings");
    ImGui::DragFloat3("Red light Direction", m_scene->getPointLightDirection(0), 0.1f, -5.0f, 5.0f);
    ImGui::End();

    ImGui::Begin("Green Light Settings");
    ImGui::DragFloat3("Green light Direction", m_scene->getPointLightDirection(1), 0.1f, -5.0f, 5.0f);
    ImGui::End();
